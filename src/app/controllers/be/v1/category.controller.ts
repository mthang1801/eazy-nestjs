...
export class CategoryController extends BaseController {
  ...
  @Post('/catalog/item')
  async createCatalogCategoryItem(@Res() res: Response, @Body() data: CreateCatalogCategoryItemDto,){
    await this.service.createCatalogCategoryItem(data);
    return this.responseSuccess(res, null, 'Tạo catalog category item thành công.');
  }
  ...
  @Get('catalog/item/:id')
  async getCatalogCategoryItemById( @Res() res: Response, @Param('id') id: number,) {
