...
export const productFeatureVariantByCategoryJoiner = {
  [JoinTable.leftJoin]: {
    [Table.PRODUCTS_CATEGORIES]: {
      fieldJoin: `${Table.PRODUCTS_CATEGORIES}.product_id`,
      rootJoin: `${Table.PRODUCT_FEATURE_VALUES}.product_id`,
...
export const BOX_PRODUCTLeftJoiner = {
  [JoinTable.leftJoin]: {
    [Table.PRODUCTS]: {
      fieldJoin: `${Table.PRODUCTS}.product_id`,
...
export const pageDetailValueJoiner = {
  [JoinTable.innerJoin]: {
    [Table.PAGE_DETAIL]: {
...
export const promoAccessoriesJoiner = {
  [JoinTable.leftJoin]: {
    [Table.PRODUCTS]: {
      fieldJoin: `${Table.PRODUCTS}.product_id`,
      rootJoin: `${Table.PRODUCT_PROMOTION_ACCESSOR_DETAIL}.product_id`,
